...
def create_milestone():
    """マイルストーンを作成"""
    milestones = [
        {"title": "MVP", "description": "最小限の動作可能な製品", "due_on": "2024-12-31T23:59:59Z"},
        {"title": "Beta", "description": "ベータ版リリース", "due_on": "2025-01-15T23:59:59Z"},
        {"title": "Production", "description": "本番リリース", "due_on": "2025-01-31T23:59:59Z"}
    ]
